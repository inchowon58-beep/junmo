...
export const CONSTRUCTION_CASES: ConstructionCase[] = [
  ...
  { id: "2", title: "군입대 전 고양이 파양 상담", type: "고양이파양", imageIndex: 2 },
  ...
  { id: "16", title: "해외 발령 전 파양 상담", type: "강아지파양", imageIndex: 16 },
...
export const REVIEWS = [
  ...
  },
  {
    name: "조*민",
    business: "고양이 파양",
    text: "무료 입소를 내세우는 곳과 달리, 처음부터 비용을 솔직히 알려주셔서 신뢰가 갔습니다. 파양 상담 전화 응답도 2시간 내였어요.",
    rating: 5,
  },
];
...
export const PROCESS_STEPS = [
  ...
  { step: "02", title: "방문·견적", desc: "예약 후 센터 방문, 입소 비용과 일정을 안내받습니다" },
